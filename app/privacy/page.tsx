...
import { ArrowLeft, ShieldCheck, Mail, Clock, ExternalLink } from "lucide-react";
import Footer from "../sections/Footer";

export const metadata: Metadata = {
  title: "Политика в отношении обработки персональных данных — PlanD",
  description:
    "Политика в отношении обработки персональных данных в соответствии с Федеральным законом № 152-ФЗ (Оператор: Кириллов Данил Борисович, веб-сайт https://plan-d.ru/).",
};
        ...
        <div className="mx-auto max-w-[920px] px-6 md:px-12">
          ...
          <header className="border-b border-concrete pb-8">
            ...
            <div className="mt-4 flex flex-wrap items-center gap-6 text-xs text-muted">
              ...
              <span>•</span>
              <span>Оператор: Кириллов Данил Борисович</span>
              <span>•</span>
              <a
                href="https://plan-d.ru/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1 text-foreground underline underline-offset-4 hover:text-brass transition-colors"
              >
                https://plan-d.ru
          ...
          {/* Policy Body */}
          <article className="prose prose-neutral max-w-none space-y-10 pt-8 text-base leading-relaxed text-muted">
            {/* Section 1 */}
            <section id="section-1" className="space-y-4">
              ...
              <p>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-medium text-foreground underline underline-offset-4 hover:text-brass"
                >
                  https://plan-d.ru/
                </a>
                .
            ...
            <section id="section-2" className="space-y-4">
              ...
              <ul className="space-y-3 pl-0 list-none">
                ...
                <li>
                  <strong className="text-foreground">2.3. Веб-сайт</strong> — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу{" "}
                  <a
                    href="https://plan-d.ru/"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <li>
                  <strong className="text-foreground">2.8. Персональные данные</strong> — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта{" "}
                  <a
                    href="https://plan-d.ru/"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <li>
                  <strong className="text-foreground">2.10. Пользователь</strong> — любой посетитель веб-сайта{" "}
                  <a
                    href="https://plan-d.ru/"
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            <section id="section-3" className="space-y-4">
              ...
              <div>
                <p className="font-medium text-foreground">3.1. Оператор имеет право:</p>
              ...
              <div className="pt-2">
                <p className="font-medium text-foreground">3.2. Оператор обязан:</p>
                <ul className="list-disc pl-6 space-y-2 mt-2">
            ...
            <section id="section-4" className="space-y-4">
              ...
              <div>
                <p className="font-medium text-foreground">4.1. Субъекты персональных данных имеют право:</p>
                <ul className="list-disc pl-6 space-y-2 mt-2">
              ...
              <div className="pt-2">
                <p className="font-medium text-foreground">4.2. Субъекты персональных данных обязаны:</p>
                <ul className="list-disc pl-6 space-y-2 mt-2">
            ...
            {/* Section 6 - Table / Structured Card */}
            <section id="section-6" className="space-y-4">
              <h2 className="font-serif text-xl text-foreground md:text-2xl">
                6. Цели обработки персональных данных
              </h2>
              <div className="overflow-hidden border border-concrete bg-white">
                <div className="grid grid-cols-1 divide-y divide-concrete md:grid-cols-2 md:divide-x md:divide-y-0">
                  <div className="p-5">
                ...
                <div className="grid grid-cols-1 border-t border-concrete divide-y divide-concrete md:grid-cols-2 md:divide-x md:divide-y-0">
                  <div className="p-5">
                    <div className="text-xs uppercase tracking-wider text-muted font-medium">
                      Правовые основания
                    </div>
            ...
            <section id="section-8" className="space-y-4">
              ...
              <p>
                ...
                <a
                  href="mailto:Info@plan-d.ru?subject=Актуализация%20персональных%20данных"
                  className="font-medium text-foreground underline underline-offset-4 hover:text-brass"
                >
                  Info@plan-d.ru
                </a>{" "}
              ...
              <p>
                ...
                <a
                  href="mailto:Info@plan-d.ru?subject=Отзыв%20согласия%20на%20обработку%20персональных%20данных"
                  className="font-medium text-foreground underline underline-offset-4 hover:text-brass"
                >
                  Info@plan-d.ru
                </a>{" "}
            ...
            {/* Section 12 */}
            <section id="section-12" className="border-t border-concrete pt-8 space-y-4">
              <h2 className="font-serif text-xl text-foreground md:text-2xl">
              ...
              <p>
                ...
                <a
                  href="https://plan-d.ru/privacy"
                  className="font-medium text-foreground underline underline-offset-4 hover:text-brass"
                >
                  https://plan-d.ru/privacy
                </a>
                .
              </p>

              {/* Fast Contact Card */}
              <div className="mt-8 rounded border border-concrete bg-white p-6 md:p-8">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-xs uppercase tracking-wider text-muted font-medium">
                        Связь с Оператором по вопросам ПДн
                      </div>
                  ...
                  <a
                    href="mailto:Info@plan-d.ru"
                    className="inline-flex items-center justify-center border border-foreground/20 bg-foreground px-5 py-2.5 text-xs font-medium uppercase tracking-[0.14em] text-alabaster transition-colors hover:bg-charcoal"
                  >
                    Написать на почту
                  </a>
                </div>
